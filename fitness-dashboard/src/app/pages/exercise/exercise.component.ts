...
export class ExerciseComponent implements OnInit {
  ...
  public exerciseData = [
    ...
    '"Basketball, officiating",1.44133935522388',
    '"Basketball, shooting baskets",0.927494089552239',
    '"Basketball, wheelchair",1.33843490149254',
    '"Running, training, pushing wheelchair",1.64782526567164',
    '"Billiards",0.515199271641791',
    '"Bowling",0.61742672238806',
    '"Boxing, in ring",2.47106089552239',
    '"Boxing, punching bag",1.23485344477612',
    '"Boxing, sparring",1.85295717014925',
    '"Coaching: football, basketball, soccer…",0.823235629850746',
    '"Cricket (batting, bowling)",1.02972154029851',
    '"Croquet",0.515199271641791',
    '"Curling",0.823235629850746',
    '"Darts (wall or lawn)",0.515199271641791',
    '"Fencing",1.23485344477612',
    '"Football, competitive",1.85295717014925',
    '"Football, touch, flag, general",1.64782526567164',
    '"Football or baseball, playing catch",0.515199271641791',
    ...
    '"Horse grooming, moderate",1.23485344477612',
    '"Horseshoe pitching",0.61742672238806',
    '"Jai alai",2.47106089552239',
    ...
    '"Wallyball",1.44133935522388',
    '"Backpacking, Hiking with pack",1.44133935522388',
    '"Carrying infant, level ground",0.721008179104478',
    '"Carrying infant, upstairs",1.02972154029851',
    '"Carrying 16 to 24 lbs, upstairs",1.23485344477612',
    '"Carrying 25 to 49 lbs, upstairs",1.64782526567164',
    '"Standing, playing with children, light",0.576806543283582',
    '"Walk/run, playing with children, moderate",0.823235629850746',
    '"Walk/run, playing with children, vigorous",1.02972154029851',
    '"Carrying small children",0.61742672238806',
    '"Loading, unloading car",0.61742672238806',
    ...
    '"Walking downstairs",0.61742672238806',
    '"Hiking, cross country",1.23485344477612',
    '"Bird watching",0.515199271641791',
    '"Marching, rapidly, military",1.33843490149254',
    '"Children\'s games, hopscotch, dodgeball",1.02972154029851',
    '"Pushing stroller or walking with children",0.515199271641791',
    '"Pushing a wheelchair",0.823235629850746',
    '"Race walking",1.33843490149254',
    '"Rock climbing, mountain climbing",1.64782526567164',
    '"Walking using crutches",1.02972154029851',
    '"Walking the dog",0.61742672238806',
    ...
    '"Boating, power, speed boat",0.515199271641791',
    ...
    '"Sledding, tobagganing, luge",1.44133935522388',
    '"Snow shoeing",1.64782526567164',
    '"Snowmobiling",0.721008179104478',
    '"General housework",0.721008179104478',
    '"Cleaning gutters",1.02972154029851',
    '"Painting",0.927494089552239',
    '"Sit, playing with animals",0.515199271641791',
    '"Walk / run, playing with animals",0.823235629850746',
    '"Bathing dog",0.721008179104478',
    '"Mowing lawn, walk, power mower",1.13262599402985',
    '"Mowing lawn, riding mower",0.515199271641791',
    '"Walking, snow blower",0.721008179104478',
    '"Riding, snow blower",0.61742672238806',
    '"Shoveling snow by hand",1.23485344477612',
    '"Raking lawn",0.885519904477612',
    '"Gardening, general",0.823235629850746',
    '"Bagging grass, leaves",0.823235629850746',
    '"Watering lawn or garden",0.310067367164179',
    '"Weeding, cultivating garden",0.927494089552239',
    '"Carpentry, general",0.721008179104478',
    '"Carrying heavy loads",1.64782526567164',
    '"Carrying moderate loads upstairs",1.64782526567164',
    '"General cleaning",0.721008179104478',
    '"Cleaning, dusting",0.515199271641791',
    '"Taking out trash",0.61742672238806',
    '"Walking, pushing a wheelchair",0.823235629850746',
    '"Teach physical education,exercise class",0.823235629850746',
  ];
